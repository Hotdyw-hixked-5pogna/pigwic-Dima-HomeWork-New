...
public class MultiplicationTable {
    public static void main(String[] args) {
        // вроде бы раньше выводило всю таблицу, а не только для одного числа или я ошибаюсь? Если пока не знаешь как распечатать красиво, то можно оставить как есть
